(function(){
    com.webrtc.WMeetingSession = Object.subClass({
        ctor : function() {

            this.sessionType = com.webrtc.UserSession.TYPE.MEETING;
        ...
        Call : function(CalleeId,Config)
        {
            ...
            if(this.Confs.moduletype == com.webrtc.UserSession.MODULE_TYPE.VIDEOMEETING)
            {
                 this.moduleList[this.SessionID] = new com.webrtc.MeetingVideoModule(this.SessionID,CalleeId,this.Confs);
                 this.moduleList[this.SessionID].SendMessageToUserSession = this.sendMessage;
                 this.moduleList[this.SessionID].captureLocalMedia(); 
            }
            else if(this.Confs.moduletype == com.webrtc.UserSession.MODULE_TYPE.AUDIOMEETING)
            {
                 this.moduleList[this.SessionID] = new com.webrtc.MeetingAudioModule(this.SessionID,CalleeId,this.Confs);
                 this.moduleList[this.SessionID].SendMessageToUserSession = this.sendMessage;
                 this.moduleList[this.SessionID].captureLocalMedia(); 
            }
            else
        ...
        addModuleType : function(sdpString)
        {
            ...
            {
                return com.webrtc.UserSession.MODULE_TYPE.VIDEOMEETING;
            }       
            else if(sdpString.indexOf("audio") != -1) 
            {
                return com.webrtc.UserSession.MODULE_TYPE.AUDIOMEETING;
            }
            else
            {
        ...
        handleMessage:function(message)
        {
            ...
            var sessionType = com.webrtc.UserSession.TYPE.MEETING;
            
            //meeting has no moduleType,use sdp information to create.
            ...
            if(msg.roap.type === com.webrtc.protocol.RTCRoapType['offer']){
                ...
                if(moduleType == com.webrtc.UserSession.MODULE_TYPE.VIDEOMEETING)
                {
                    ...
                    if(false == this.isExistModule(sessionID))
                    {
                        ...
                        var configuration = new Conf(com.webrtc.UserSession.TYPE.MEETING,com.webrtc.UserSession.MODULE_TYPE.VIDEOMEETING,false,true, { "urls": "turn:222.200.180.144","url": "turn:222.200.180.144","credential":"123456","username":"gsta"},false);
                        this.moduleList[sessionID] = new com.webrtc.MeetingVideoModule(sessionID,RemoteID,configuration);
                ...
                else if(moduleType == com.webrtc.UserSession.MODULE_TYPE.AUDIOMEETING)
                {
                    ...
                    if(false == this.isExistModule(sessionID))
                    {
                        ...
                        var configuration = new Conf(com.webrtc.UserSession.TYPE.MEETING,com.webrtc.UserSession.MODULE_TYPE.AUDIOMEETING,false,true, { "urls": "turn:222.200.180.144","url": "turn:222.200.180.144","credential":"123456","username":"gsta"},false);
                        this.moduleList[sessionID] = new com.webrtc.MeetingAudioModule(sessionID,RemoteID,configuration);
                        this.moduleList[sessionID].SendMessageToUserSession = this.sendMessage;
